...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request object for updating an item quantity in the shopping cart")
public class UpdateCartItemRequest extends BaseRequest {
    ...
    @Schema(description = "The target number of items in cart (setting to 0 will remove the item)", example = "2")
